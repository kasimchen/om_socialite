...
abstract class AbstractProvider implements ProviderInterface
{
     ...
     * @return array
     */
    abstract protected function getUserByIdToken(AccessTokenInterface $token);
     ...
     * @return \Overtrue\Socialite\User
     * */
    abstract protected function mapUserToObjectIdToken(array $user);
     ...
     * {@inheritdoc}
     */
    public function userIdToken(AccessTokenInterface $token = null)
    {
        ...
        $user = $this->getUserByIdToken($token);

        if(!empty($user['error_description'])){
            return false;
        }

        $user = $this->mapUserToObjectIdToken($user)->merge(['original' => $user]);
